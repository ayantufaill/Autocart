...
const LoginModal: React.FC<LoginModalProps> = ({ handleSignInModalOpen, modalOpen, handleModalClose }) => {
    const loginOptions = [
        ...
        >
            <Box sx={styles.modalWrapper}>
                ...
                <Box sx={styles.buttonWrapper}>
                    {loginOptions.map((option, index) => <Button key={index}
                        variant='outlined'
                        disableTouchRipple
                ...
                <IconButton onClick={handleModalClose} sx={{ position: "absolute", top: 2, right: 2 }}>
                    <Close />
                </IconButton>
            </Box>
        </Modal>
