...
const VehicleForm = () => {
    ...
    return (
        <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', gap: 2, py: 4 }}>
            ...
            {formData.category && <Stack spacing={1}>
                ...
                <Box sx={{ display: 'flex', gap: 2 }}>
                    <TextField
                        ...
                        sx={{ width: "60%" }}
                    />
                    <Button variant="contained" sx={{ width: "40%", color: "#FFF", bgcolor: "#07B007" }}>
                        Find
                    </Button>
                </Box>
            </Stack>}
            ...
            {formData.category && <Stack spacing={1}>
                ...
                <FormControl fullWidth>
                    ...
                    >
                        <MenuItem disabled value="">
                            <span style={{ color: "#9CA3AF", fontSize: "14px" }}>Select Status</span>
                        </MenuItem>
            ...
            {
                formData.category === "commercialMake" && <Stack spacing={1}>
            ...
            {
                formData.category === "commercialModel" && <Stack spacing={1}>
            ...
            {formData.category && <Stack spacing={1}>
                ...
                <FormControl fullWidth>
                    ...
                    >
                        <MenuItem disabled value="">
                            <span style={{ color: "#9CA3AF", fontSize: "14px" }}>Select Ad Type</span>
                        </MenuItem>
            ...
            {formData.category === "motorbikes" && <Stack spacing={1}>
            ...
            <Stack spacing={1}>
                ...
                <Typography variant='body2' sx={{ color: "#9CA3AF" }}>You can upload up to 20 images</Typography>
                <ImageList cols={4} gap={8} sx={{ mt: 2 }}>
                    ...
                    >
                        <Image src="/images/upload.svg" alt="upload image" width={20} height={20} />
                    </ImageListItem>
            ...
            <Stack spacing={1}>
                ...
                <Typography variant='body2' sx={{ color: "#9CA3AF" }}>You can upload up to 5 Images or videos for story</Typography>
                <ImageList cols={4} gap={8} sx={{ mt: 2 }}>
                    <ImageListItem
                        sx={{
                            display: 'flex',
            ...
            <Button variant='outlined' sx={{ height: "48px", color: "#07B007", borderColor: "#07B007", borderRadius: 2, mt: 1 }}>Preview Story</Button>
            ...
            <Box sx={{ bgcolor: "#F9FAFB", p: { xs: "16px" }, borderRadius: 2 }}>
                <Typography sx={{ fontWeight: 600, color: "#1F2937" }}>Ad Details</Typography>
                <Typography variant='body2' sx={{ color: "#9CA3AF", my: 2 }}>Standard Car Post</Typography>
                <Typography sx={{ mt: 2, fontSize: "12px", color: "#1F2937" }}><span style={{ color: "#07B007", marginRight: 10 }}>✔</span>30 Days Car Listing</Typography>
                <Typography sx={{ mt: 2, fontSize: "12px", color: "#1F2937" }}><span style={{ color: "#07B007", marginRight: 10 }}>✔</span>Upto 20 Images</Typography>
                <Typography sx={{ mt: 2, fontSize: "12px", color: "#1F2937" }}><span style={{ color: "#07B007", marginRight: 10 }}>✔</span>2x Bump up to the top </Typography>
            </Box>

            <Button variant='contained' sx={{ height: "48px", color: "#FFF", bgcolor: "#07B007", mt: 2, borderRadius: 2 }}>Publish Ad</Button>
            <Button variant='outlined' sx={{ height: "48px", color: "#07B007", borderColor: "#07B007", borderRadius: 2 }}>Preview Ad</Button>
        </Box>
    );
};
